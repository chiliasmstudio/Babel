...
public class test3 {
    public static void main(String[] args) throws Exception {
        ...
        Ed448KeyGenerationParameters params = new Ed448KeyGenerationParameters(new SecureRandom());
        ...
        // 将私钥信息（PrivateKeyInfo）转换为 PEM 格式的字符串
        ASN1Object privateKeyInfo = PrivateKeyInfo.getInstance(privateKey.getEncoded());
        ...
        try (FileWriter privateKeyWriter = new FileWriter("private_key.pem")) {
            ...
            System.out.println("私钥已保存为 PEM 格式文件 private_key.pem");
        } catch (IOException e) {
            e.printStackTrace();
        }
